...
{
    public partial class DarseBaja : Form
    {
        Socket server;
        Thread atender;
        ...
        public DarseBaja(int puerto)
        {
            InitializeComponent();
            this.puerto = puerto;
        }

        private void DarseBaja_Load(object sender, EventArgs e)
        {
        ...
        private void atenderServidor()
        {
            while (true)
            {
                ...
                switch (codigo)
                {
                    case 17: // Dar de baja al usuario.
        ...
        private void botonBaja_Click(object sender, EventArgs e)
        {
            if (!conectado)
            {
                if ((usuarioBox.Text.Trim() != string.Empty) && (contraseñaBox.Text.Trim() != string.Empty))
                {
                    ...
                    string mensaje = "17/" + usuario + "/" + contraseña + "/";
        ...
        {
            iniciarLabel.ForeColor = Color.DarkOrange;
        }
